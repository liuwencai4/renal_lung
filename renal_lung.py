...
#应用标题
st.title('A machine learning-based predictive model for predicting lung metastasis in patients with renal cancer')
...
features = ['Primary.Site','Sequence number','Grade','T','N','Tumor.Size','Brain.metastases','Liver.metastasis','Bone.metastases']
...
sp = 0.5
#figure
is_t = (XGB.predict_proba(np.array([[Primary_Site,Sequence_number,Grade,T,N,Tumor_Size,Brain_metastases,Liver_metastasis,Bone_metastases]]))[0][1])> sp
prob = (XGB.predict_proba(np.array([[Primary_Site,Sequence_number,Grade,T,N,Tumor_Size,Brain_metastases,Liver_metastasis,Bone_metastases]]))[0][1])*1000//1/10
